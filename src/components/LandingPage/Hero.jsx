...
const Hero = React.memo(() => {
  ...
  return (
<section className="relative bg-linear-to-br from-slate-50 via-white to-blue-50/30 overflow-y-visible min-h-[80vh] flex items-center">


  <div className="hidden lg:block absolute -right-62.5 -top-37.5 w-150 h-150
    bg-linear-to-bl from-[#7bbfae]/15 via-[#5da897]/10 to-transparent
    rounded-[40%_60%_70%_30%/40%_40%_60%_60%] z-0 blur-3xl"
    style={{ animation: "float 20s ease-in-out infinite" }}>
  </div>

  {/* Medium Blob - Bottom Left with Animation */}
  <div className="hidden lg:block absolute -left-45 -bottom-25 w-125 h-125
    bg-linear-to-tr from-[#2f5349]/12 via-[#4a6f60]/8 to-transparent
    rounded-[55%_45%_35%_65%/60%_30%_70%_40%] z-0 blur-3xl"
    style={{ animation: "float 25s ease-in-out infinite reverse" }}>
  </div>

  {/* Center Accent Blob */}
  <div className="hidden lg:block absolute left-[50%] top-[45%] -translate-x-1/2 -translate-y-1/2 w-112.5 h-112.5
    bg-linear-to-br from-[#ffc800]/8 via-[#f5c542]/5 to-transparent
  ...
  <div className="hidden lg:block absolute left-[5%] top-[15%] w-62.5 h-62.5
    bg-linear-to-br from-[#7bbfae]/10 to-transparent
  ...
  <div className="hidden lg:block absolute right-[8%] top-[60%] w-75 h-75
    bg-linear-to-tl from-[#ffc800]/10 to-transparent
  ...
  <div className="absolute inset-0 bg-linear-to-t from-white/50 via-transparent to-transparent z-1 pointer-events-none"></div>
  ...
  <div className="relative z-20 max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 text-center py-12 sm:py-16 md:py-20 lg:py-24">
    ...
    <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold text-gray-900 leading-[1.1] tracking-tight mb-6 sm:mb-8">
      Find Local Services
      <br />
      <span className="bg-linear-to-r from-[#2f5349] via-[#5da897] to-[#7bbfae] bg-clip-text text-transparent
  ...
  {showResults && searchResults.length > 0 && (
    <div className="absolute top-full mt-2 w-[90%]  bg-white rounded-2xl shadow-2xl border border-gray-100 overflow-hidden z-50 max-h-100 overflow-y-auto">
